                ...
                {(order.expected_arrival_date_snapshot || order.destination?.expected_arrival_date) && (
                  <div>
                    ...
                    <span className="font-bold text-forest-800 flex items-center gap-1 mt-0.5">
                      ...
                      {new Intl.DateTimeFormat("fr-FR", { day: "numeric", month: "long", year: "numeric" }).format(new Date(order.expected_arrival_date_snapshot || order.destination!.expected_arrival_date))}
                    </span>
                  </div>
                )}
